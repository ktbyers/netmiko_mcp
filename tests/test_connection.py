...
def test_run_show_command_success(mock_get_params: MagicMock, mock_connect: MagicMock) -> None:
...
@patch("netmiko_mcp.connection.get_device_params")
def test_run_show_command_inventory_error(mock_get_params: MagicMock) -> None:
...
@patch("netmiko_mcp.connection.ConnectHandler")
@patch("netmiko_mcp.connection.get_device_params")
def test_run_show_command_auth_error(mock_get_params: MagicMock, mock_connect: MagicMock) -> None:
...
def test_run_show_command_timeout_error(
    mock_get_params: MagicMock, mock_connect: MagicMock
) -> None:
