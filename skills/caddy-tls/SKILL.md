...
> **For humans:** This file is reference documentation for setting up TLS with Caddy in front of netmiko-mcp. You can read it directly, but its real purpose is to be installed as a skill in your AI client — once loaded into Claude's context, you can ask it to walk you through the setup and it already has all the details. See the [Claude Code Skills](../../README.md#claude-code-skills) section in the README for installation instructions.
